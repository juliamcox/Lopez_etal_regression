function [X,Y,trialIndicator,numFun,basisSets,meanFluor,fluor] = createPredictorMatrix_activeAvoid(params,eventNames,timeBack,timeForward,sessIDs,dataLoc,shuffFlag)
